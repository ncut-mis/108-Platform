        ...
        <div class="content">
            <div class="col-md-8" style="margin-top:3%;float:left;">
                ...
                <br><center>
                    ...
                    if($_SESSION['have']==1)
                    {
                        echo" <a class='btn btn-sm btn-secondary' style='' href='/schedule/next/build'>下個月班表</a>";
                    }
                   else if($_SESSION['have']==0)
                       {
                           echo"<button type='button' class='btn btn-sm btn-secondary' data-bs-toggle='collapse' data-bs-target='#ss'>建立下個月班表</button>";
                ...
                <div id="ss" class="collapse" style="margin-left: 5%">
                    <h4> <a class="a1"><i class="bi bi-pen"></i>&nbsp;下個月班表設定</a></h4><br>
                    <form action="{{route('schedule.build')}}" method="GET">
                        每時段預設人數:&nbsp;
                        <select name="number" style="color:gray;font-weight:bold">
                            <option value="1"> 1 </option>
                            <option value="2"> 2 </option>
                        ...
                        &nbsp;
                        <input type="submit" class="btn btn-sm btn-secondary" value="建立">
                    </form>
